...
RUN apt-get install -y curl wget file tar bzip2 gzip unzip bsdmainutils python3 lib32z1 util-linux ca-certificates binutils bc jq tmux netcat lib32gcc-s1 lib32stdc++6 git nano
