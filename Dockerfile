...
RUN yum -y install curl nano nload top screen git ps wget tar bzip2 gzip unzip zlib.i686 lib32z1 python3 binutils bc jq tmux glibc.i686 libstdc++ libstdc++.i686 \
